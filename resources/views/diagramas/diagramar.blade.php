...
<x-app-layout>
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-13 col-md-auto ms-auto">
                        <div class="row">
                            <div class="col-auto mx-0 px-2">
                                ...
                                <div class="datagrid-content">
                                    ...
                                    <div class="avatar-list">
                                        ...
                                        @if ($usuario->url)
                                        <span class="avatar avatar-xs avatar-rounded cursor-help" style="background-image: url({{ asset('storage/' . $usuario->url) }}); box-shadow: 0 0 0 2px #597e8d;" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<p class='mb-0'>{{ $usuario->name }} - Participante</p><p class='mb-0'><a href='#'>{{ $usuario->email }}</a></p>">
                                            <span id="user_{{ $usuario->id }}" class="badge bg-red"></span></span>
                                        @else
                                        <span class="avatar avatar-xs avatar-rounded cursor-help" data-bs-toggle="popover" data-bs-placement="top" data-bs-html="true" data-bs-content="<p class='mb-0'>{{ $usuario->name }} - Participante</p>
                                                        <p class='mb-0'><a href='#'>{{ $usuario->email }}</a></p>
                                                        ">{{ Str::substr($usuario->name, 0, 2) }}<span id="user_{{ $usuario->id }}" class="badge bg-red"></span></span>
                                        @endif
                                        @endif
                                        @endforeach
                                    </div>
                            ...
                            <div class="col-auto">
                                <a href="{{ route('diagramas.generarJavaCode', $diagrama) }}" class="btn btn-white" title="JAVA">
                                    <img src="{{ asset('/assets/img/javaIcon.png') }}" width="75">
                                </a>
                            </div>

                            <div class="col-auto">
                                <a href="{{ route('diagramas.generarCCode', $diagrama) }}" class="btn btn-white" title="C#">
                                    <img src="{{ asset('/assets/img/cIcon.png') }}" width="75">
                                </a>
                            </div>

                            <div class="col-auto">
                                <a href="{{ route('diagramas.generarDartCode', $diagrama) }}" class="btn btn-white" title="DART">
                                    <img src="{{ asset('/assets/img/dartIcon.png') }}" width="75" height="70">
                                </a>
                            </div>
    ...
    <div id="app">
        ...
        <div class="app-body">
            ...
            <div class="inspector-container" style="background-color: rgb(120, 120, 120)"></div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Importar desde Architect</h5><img src="{{ asset('/assets/img/enterprise-architect-logo.png') }}" width="75">
                ...
                <form action="{{ route('exportar') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <a href="#" class="btn btn-link link-secondary bg-danger text-white" data-bs-dismiss="modal">
                            Cancelar
                        </a>
    ...
    <script>
        ...
        async function guardar(paper) {
            try {

                const res = await axios.post("/diagramas/guardar", {
                    id: diagrama_id,
                    contenido: paper
                })
    ...
    <script>
        ...
        Echo.connector.pusher.connection.bind('connected', function() {
            console.log('Conexión Pusher establecida');
        });

        Echo.join(`diagramar.${diagrama_id}`).listen('DiagramaSent', (e) => {
                console.log('di', e.diagrama.contenido)
