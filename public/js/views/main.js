...
(function (_, joint) {
    ...
    App.MainView = joint.mvc.View.extend({
        ...
        initializePaper: function () {
            ...
            // Listen to cell events to emit updates to the server
            ...
            paper.on(
                "blank:mousewheel",
                _.partial(this.onMousewheel, null),
                this
            );
            ...
            this.graph.on(
                ...
                function (cell) {
                    ...
                    if (this.selection.collection.has(cell)) {
                        this.selection.collection.reset(
                            this.selection.collection.models.filter(
                                (c) => c !== cell
                            )
                        );
                    }
        ...
        onSelectionChange: function () {
            ...
            /* console.log(this.paper.model.toJSON()); */
        },
        ...
        initializeToolbar: function () {
            ...
            toolbar.on({
                ...
                "to-back:pointerclick": this.applyOnSelection.bind(
                    this,
                    "toBack"
                ),
